...
LABEL org.opencontainers.image.source="https://github.com/wize-works/wize-log"
LABEL org.opencontainers.image.documentation="https://github.com/wize-works/wize-log"
