...
[![status](https://img.shields.io/badge/status-active-brightgreen)](https://github.com/wizeworks/wize-wize-log)  
...
**wize-log** is a lightweight, multi-tenant **GraphQL API** for managing wize-logs, designed for flexible client applications.  
